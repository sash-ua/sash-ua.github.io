System.registerDynamic("npm:normalize.css@4.2.0/normalize.css", [], false, function ($__require, $__exports, $__module) {
...
System.registerDynamic("js/model.js", ["npm:lodash@4.15.0/lodash.js"], true, function ($__require, exports, module) {
    "use strict";

    var define,
        global = this || self,
        GLOBAL = global;
    var _ = $__require("npm:lodash@4.15.0/lodash.js");
    var Model = function () {
        function Model() {
            this.obj = new Map();
            this.tpl = {
        ...
        Model.addClass = function (el, classItem, f, classesList) {
            if (f === void 0) {
                f = 0;
            }
            if (classesList === void 0) {
                classesList = '';
            }
            var idEl = document.getElementById(el),
        ...
        Model.delClass = function (className) {
            var allSelectors = document.querySelectorAll('.' + className);
            for (var i = 0; i < allSelectors.length; i++) {
                allSelectors[i].classList.remove(className);
            }
        };
        // if f = 1 then sorting original map obj., else return sorted clone of it.
        Model.sorting = function (state, mapObj, f) {
            if (f === void 0) {
                f = 0;
            }
            var tempObj = mapObj;
            if (f) {
                tempObj.forEach(function (value, key, map) {
        ...
        Model.quantityActTodos = function (state, mapObj) {
            var t = 0;
        ...
        Model.prototype.addTodoItem = function (enteredTodo) {
            var todo,
        ...
        Model.prototype.getTpl = function () {
            return this.tpl;
        };
        Model.prototype.addItem = function (key, item) {
            this.obj.set(key, item);
            return this.obj;
        };
        Model.prototype.removeItem = function (key) {
            this.obj.delete(key);
            return this.obj;
        };
        ...
        Model.prototype.checkItem = function (key) {
            this.obj.has(key);
            return this.obj;
        };
        Model.prototype.counter = function () {
            this.c++;
        };
        Model.prototype.genTodoName = function () {
            this.counter();
            return "todo" + this.c;
        };
        // check / uncheck all checked symbols
        Model.prototype.selectAll = function (state, mapObj) {
            if (mapObj === void 0) {
                mapObj = this.obj;
            }
            var origin = mapObj;
        ...
        Model.prototype.selectTodo = function (el, mapObj) {
            if (mapObj === void 0) {
                mapObj = this.obj;
            }
            mapObj.forEach(function (value, key, map) {
        ...
        Model.prototype.editTodo = function (el, elValue, mapObj) {
            if (mapObj === void 0) {
                mapObj = this.obj;
            }
            mapObj.forEach(function (value, key, map) {
        ...
        Model.prototype.revChecked = function (mapObj) {
            if (mapObj === void 0) {
                mapObj = this.obj;
            }
            var s = mapObj.size,
        ...
        Model.prototype.filters = function (e) {
            if (e.target.id === 'all') {
                return this.getObj();
        ...
        Model.prototype.checkView = function (mapObj, tpl) {
        ...
        Model.prototype.todoEditMode = function (e, todoEdit) {
            var _this = this;
            var elId = e.target.getAttribute('data-id'),
                el = document.getElementById(elId),
                loseFocusEv,
                escEv;
            Model.addClass(elId, this.getTpl().classItem[3], 1);
            // if focus loses edit field escape
            todoEdit.addEventListener('blur', loseFocusEv = function (e) {
                Model.addClass(elId, _this.getTpl().classItem[3], 2);
                todoEdit.removeEventListener('blur', loseFocusEv);
            });
            //if press 'esc' edit field escape
            todoEdit.addEventListener('keydown', escEv = function (e) {
                if (e.keyCode === 27) {
                    Model.addClass(elId, _this.getTpl().classItem[3], 2);
                    todoEdit.value = '';
...
System.registerDynamic('js/view.js', ['npm:lodash@4.15.0/lodash.js'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var _ = $__require('npm:lodash@4.15.0/lodash.js');
    var View = function () {
        function View(mapObj, tpl) {
            this.mapObj = mapObj;
            this.tpl = tpl;
            this.el = document.getElementById('list-id');
        }
        View.insert = function (elId, str) {
            document.getElementById(elId).innerHTML = str;
        };
        View.prototype.createTpl = function (obj) {
            var _this = this;
            var html = '';
            obj.forEach(function (value, key, map) {
                html += _.template(_this.tpl.input)(value);
            });
            return html;
        };
        View.prototype.renderTpl = function (obj) {
            if (obj === void 0) {
                obj = this.mapObj;
            }
...
System.registerDynamic('js/controller.js', ['js/model.js', 'js/view.js'], true, function ($__require, exports, module) {
    "use strict";

    var define,
        global = this || self,
        GLOBAL = global;
    var model_js_1 = $__require('js/model.js');
    var view_js_1 = $__require('js/view.js');
    var Controller = function () {
        function Controller(enteredTodo) {
            this.enteredTodo = enteredTodo;
            this.m = new model_js_1.Model();
            this.v = new view_js_1.View(this.m.getObj(), this.m.getTpl());
        }
        Controller.prototype.htmlRender = function (mapObj) {
            if (mapObj === void 0) {
                mapObj = this.m.getObj();
            }
            this.v.renderTpl(mapObj);
            this.m.checkView(this.m.getObj(), this.m.getTpl());
        };
        Controller.prototype.checkInputTodo = function (e) {
            if (e.keyCode === 13 && e.target.value.replace(/(\s)+/g, '').length > 0) {
                model_js_1.Model.delClass(this.m.getTpl().classItem[2]);
                if (e.target.id === 'todos__insert-item') {
                    this.m.addTodoItem(e.target);
                    e.target.value = '';
                    this.htmlRender();
                    view_js_1.View.insert(this.m.getTpl().el[1], this.m.getObj().size);
                } else {
                    var el = e.target.getAttribute('data-id');
                    this.m.editTodo(el, e.target.value, this.m.getObj());
                    this.htmlRender();
                    view_js_1.View.insert(this.m.getTpl().el[1], this.m.getObj().size);
                    model_js_1.Model.addClass(el, this.m.getTpl().classItem[3], 2);
                }
            }
            e.target.removeEventListener('keypress', this.checkInputTodo);
        };
        Controller.prototype.checkAllTodos = function (e) {
        ...
        Controller.prototype.checkOneTodo = function (e) {
            var el = e.target.getAttribute('data-id');
            if (e.target.checked === true) {
        ...
        Controller.prototype.delOneTodo = function (e) {
            var el = e.target.getAttribute('data-id'),
                locMapObj = this.m.removeItem(el);
            this.htmlRender();
            view_js_1.View.insert(this.m.getTpl().el[1], locMapObj.size);
            model_js_1.Model.delClass(this.m.getTpl().classItem[2]);
        };
        Controller.prototype.filters = function (e) {
            var objLocal = this.m.filters(e),
                classesList = e.target.classList;
            this.htmlRender(objLocal);
            model_js_1.Model.addClass(this.m.getTpl().el[2], this.m.getTpl().classItem[2], 3, classesList);
            if (objLocal) {
                //insert quantity of todos.
                view_js_1.View.insert(this.m.getTpl().el[1], objLocal.size);
            }
        };
        Controller.prototype.dblclkHandler = function (el) {
            var _this = this;
            el.addEventListener('dblclick', function (e) {
                var ev = e;
                if (e.target.tagName === 'LABEL') {
                    var todoEditId = ev.target.children[0];
                    _this.m.todoEditMode(ev, todoEditId);
                }
            }, false);
        };
        Controller.prototype.clickHandler = function (el) {
            var _this = this;
            el.addEventListener('keypress', this.checkInputTodo.bind(this));
            el.addEventListener('click', function (e) {
                if (e.target.tagName === 'INPUT') {
                    e.target.addEventListener('keypress', _this.checkInputTodo.bind(_this));
                }
                if (e.target.id === 'todos__check-all') {
                    _this.checkAllTodos(e);
                }
                if (e.target.classList.contains('todos__checkbox_sub')) {
                    _this.checkOneTodo(e);
                }
...
System.registerDynamic('js/main.js', ['npm:normalize.css@4.2.0/normalize.css', 'js/controller.js'], true, function ($__require, exports, module) {
  'use strict';

  var define,
      global = this || self,
      GLOBAL = global;
  $__require('npm:normalize.css@4.2.0/normalize.css');
  var controller_js_1 = $__require('js/controller.js');
  var enteredTodo = document.getElementById('todos__insert-item'),
      todosBody = document.getElementById('todos__body-id');
  var c = new controller_js_1.Controller(enteredTodo);
