##The web application [To Do list v.3.1.0 (Angular 2), demo]( https://sash-ua.github.io/todo-angular2-v.3.1.0/ ). [Code]( https://github.com/sash-ua/todo-angular2-v.3.1.0 ).
